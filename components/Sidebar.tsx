...
const Sidebar = ({fullName, avatar, email}: Props) => {
  ...
  return (
    <aside className='sidebar'>
        <Link href=''>
          <Image src="/Logo-Full.png" alt="" width={160} height={50} className="hidden h-auto lg:block" />
          <Image src="/Logo-Red.png" alt="" width={52} height={52} className="lg:hidden" />
        </Link>
        ...
        <div className='sidebar-user-info'>
            ...
            <div className='hidden lg:block'>
                <p className='subtitle-2 caitalize'>{fullName}</p>
